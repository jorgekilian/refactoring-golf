...
namespace Hole5.Tests
{
    public class TakeHomeCalculatorTest
    {
        ...
        {
            int first = new TakeHomeCalculator(10, taxRate = new TaxRate(this)).NetAmount(Money.Create(40, "GBP"),
                Money.Create(50, "GBP"),
        ...
        {
            Assert.Throws<Incalculable>(() => new TakeHomeCalculator(10, taxRate = new TaxRate(this)).NetAmount(
